...
def compute_errors(u_e, u):
	...
	# L2 norm
	L2n = errornorm(u_e, u, norm_type='L2', degree_rise=3)

	# H1 seminorm
	H1_0 = errornorm(u_e, u, norm_type='H10', degree_rise=3)

	H1 = np.sqrt(L2n**2 + H1_0**2)
...
def a(u_tilde, u_, t):
	# abs (u_ - u_tilde)
	#abs_ind = Expression('abs(a-b)', degree = 2, a = u_, b = u_tilde)
	#abs_ind = interpolate(abs_ind, Q)
